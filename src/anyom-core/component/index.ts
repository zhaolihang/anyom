...
import { NativeElement, getParentNode } from "../native/index";
...
function updateParentComponentVNodes(vNode: VNode, dom: NativeElement) {
...
function applyState<P, S>(
  ...
  if (force || !component._blockRender) {
    ...
    const parentDom =
      (lastInput.dom && getParentNode(lastInput.dom)) ||
    ...
    const dom = (vNode.dom = (nextInput as VNode).dom as NativeElement);
