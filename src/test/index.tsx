...
import Select from "../element-ui/src/select/Select";
import Option from "../element-ui/src/select/Option";
...
let firstVNode;
// layout test
// firstVNode = <div className='demo-layout'>
...
class TestLifeAtom extends Component {
    created() {
        log('TestLifeAtom created')
    }
    mounted() {
        log('TestLifeAtom mounted')
    }
    render() {
        return <div>
            {this.props.children}
...
class TestLifeRow extends Component {
    created() {
        log('TestLifeRow created')
    }
    mounted() {
        log('TestLifeRow mounted')
    }
    render() {
        return <TestLifeAtom>
            {this.props.children}
...
class TestLifeCol extends Component {
    created() {
        log('TestLifeCol created')
    }
    mounted() {
        log('TestLifeCol mounted')
    }
    render() {
        return <TestLifeRow>
            <TestLifeAtom></TestLifeAtom>
        </TestLifeRow>
    }
}
...
class TestSelect extends Component {
    ...
    render() {
        return <Select value={this.value} multiple={true} filterable={true}>
            {
                this.options.map(el => {
